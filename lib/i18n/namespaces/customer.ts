export const customerEN = {
  ...
  'rewards.limited': 'LIMITED',
  'rewards.noRewardsTitle': 'No rewards available',
  'rewards.noRewardsSub': 'Check back soon — new rewards are added regularly. Keep playing to build up your points.',
  'rewards.noRewardsBack': 'Back to home',
  'rewards.stepSelect': 'Select',
  'rewards.stepConfirm': 'Confirm',
  'rewards.stepSubmitted': 'Submitted',
  'rewards.yourBalance': 'Your balance',
  'rewards.continue': 'Continue',
  'rewards.reviewTitle': 'Review your redemption',
  'rewards.currentBalance': 'Current balance',
  'rewards.thisReward': 'This reward',
  'rewards.remaining': 'Remaining',
  'rewards.confirmNote': 'Confirming sends a request to the counter. Staff approve it and hand over your item at the counter.',
  'rewards.confirmRedemption': 'Confirm redemption',
  'rewards.submittedTitle': 'Redemption requested',
  'rewards.submittedSub': 'Show this at the counter — staff will approve it and hand over your item.',
  'rewards.requestRef': 'Request ref',
  'rewards.pendingApprovalBadge': 'PENDING APPROVAL',
  'rewards.rewardName': 'Reward',
  'rewards.pointsHeld': 'Points held',
  'rewards.dateRequested': 'Requested',
  'rewards.heldNote': 'Your points are held until approved. Cancel before approval to get them back.',
  'rewards.viewHistory': 'View history',
  'rewards.done': 'Done',
  'rewards.counterNote': 'Redemptions are approved at the counter, where you collect your item.',
} as const
...
export const customerMY: { [K in keyof typeof customerEN]: string } = {
  ...
  // Rewards flow
  'rewards.redeem': 'လဲယူရန်',
  'rewards.limited': 'အကန့်အသတ်',
  'rewards.noRewardsTitle': 'ဆုလာဘ် မရှိသေးပါ',
  'rewards.noRewardsSub': 'မကြာမီ ဆုလာဘ်အသစ်များ ထည့်သွင်းမည်ဖြစ်သည်။ ဆက်ကစားပြီး ပွိုင့်များ စုဆောင်းပါ။',
  'rewards.noRewardsBack': 'ပင်မသို့ ပြန်ရန်',
  'rewards.stepSelect': 'ရွေးချယ်',
  'rewards.stepConfirm': 'အတည်ပြု',
  'rewards.stepSubmitted': 'တင်ပြီး',
  'rewards.yourBalance': 'သင့်ပွိုင့်',
  'rewards.continue': 'ဆက်လုပ်ရန်',
  'rewards.reviewTitle': 'တောင်းဆိုမှု စစ်ဆေးပါ',
  'rewards.currentBalance': 'လက်ရှိ ပွိုင့်',
  'rewards.thisReward': 'ဤဆုလာဘ်',
  'rewards.remaining': 'ကျန်မည့်',
  'rewards.confirmNote': 'ကောင်တာတွင် ဝန်ထမ်းမှ အတည်ပြုပြီး ပစ္စည်းပေးမည်ဖြစ်သည်။',
  'rewards.confirmRedemption': 'တောင်းဆိုမှုအတည်ပြု',
  'rewards.submittedTitle': 'တောင်းဆိုမှု တင်ပြီး',
  'rewards.submittedSub': 'ကောင်တာတွင် ဝန်ထမ်းမှ အတည်ပြုပြီး ပစ္စည်းပေးမည်ဖြစ်သည်။',
  'rewards.requestRef': 'တောင်းဆိုမှုနံပါတ်',
  'rewards.pendingApprovalBadge': 'အတည်ပြုရန် ကျန်',
  'rewards.rewardName': 'ဆုလာဘ်',
  'rewards.pointsHeld': 'ပွိုင့်ထိန်းသိမ်းထား',
  'rewards.dateRequested': 'တောင်းဆိုသောနေ့',
  'rewards.heldNote': 'အတည်ပြုသည်အထိ ပွိုင့်များ ထိန်းသိမ်းထားမည်ဖြစ်သည်။',
  'rewards.viewHistory': 'မှတ်တမ်းကြည့်ရန်',
  'rewards.done': 'ပြီးပြီ',
  'rewards.counterNote': 'ဆုလာဘ်ကို ကောင်တာတွင်သာ ရယူနိုင်ပါသည်။',
}
