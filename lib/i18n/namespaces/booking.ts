...
export const bookingMY: { [K in keyof typeof bookingEN]: string } = {
  ...
  'booking.book.freeCancel': 'အချိန် ၁၂ နာရီကြိုပြီး ဘွတ်ကင်ဖျက်ပါက အပြည့်အဝ‌ စပေါ်ငွေပြန်အမ်း',
  ...
  'booking.confirm.submittedSub': 'စပေါ်ငွေရောက်ပြီးတာနဲ့ Viber သို့မဟုတ် SMS မှ အကြောင်းပြန်ပါမည်။',
  ...
  'booking.admin.confirmDeposit': 'အပေါင်အတည်ပြုရန်',
  'booking.admin.cancelBooking': 'ဘွတ်ကင်ပယ်ဖျက်ရန်',
  'booking.admin.depositLabel': 'အပေါင်ငွေ',
