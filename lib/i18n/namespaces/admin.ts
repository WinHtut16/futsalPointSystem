export const adminEN = {
  ...
  'audit.subtitle': 'Who changed what, across all three businesses.',
  'audit.navAudit': 'Audit log',
  'audit.allBusinesses': 'All businesses',
  'audit.allActivity': 'All activity',
  'audit.decisionsOnly': 'Decisions & corrections',
  'audit.days7': 'Last 7 days',
  'audit.days30': 'Last 30 days',
  'audit.days90': 'Last 90 days',
  'audit.empty': 'Nothing recorded in this period.',
  'audit.loadFailed': 'Could not load the audit log. Nothing is missing — this page just could not read it. Try again.',
  'audit.clearActor': 'Show everyone again',
  'audit.accessGranted': 'gave {target} access.',
  ...
  'audit.catalogueCreated': 'added the {kind} {target}.',
  'audit.catalogueUpdated': 'changed the {kind} {target}: {changes}',
  'audit.catalogueRemoved': 'removed the {kind} {target}.',
  'audit.settingsUpdated': 'changed settings: {changes}',
  'audit.nounMenuItem': 'menu item',
  'audit.nounTable': 'table',
  'audit.nounProduct': 'product',
  'audit.nounStation': 'station',
...
export const adminMY: { [K in keyof typeof adminEN]: string } = {
  ...
  'audit.title': 'လုပ်ဆောင်မှု မှတ်တမ်း',
  'audit.subtitle': 'လုပ်ငန်းသုံးခုလုံးတွင် မည်သူက ဘာပြောင်းလဲခဲ့သည်ကို ကြည့်ရန်။',
  'audit.navAudit': 'လုပ်ဆောင်မှု မှတ်တမ်း',
  'audit.allBusinesses': 'လုပ်ငန်းအားလုံး',
  'audit.allActivity': 'လုပ်ဆောင်မှု အားလုံး',
  'audit.decisionsOnly': 'ဆုံးဖြတ်ချက်နှင့် ပြင်ဆင်မှုများ',
  'audit.days7': 'ပြီးခဲ့သော ၇ ရက်',
  'audit.days30': 'ပြီးခဲ့သော ၃၀ ရက်',
  'audit.days90': 'ပြီးခဲ့သော ၉၀ ရက်',
  'audit.empty': 'ဤကာလအတွင်း မှတ်တမ်း မရှိပါ။',
  'audit.loadFailed': 'မှတ်တမ်းကို ဖတ်၍ မရပါ။ မှတ်တမ်း ပျောက်သွားခြင်း မဟုတ်ပါ — ဤစာမျက်နှာက ဖတ်မရခြင်းသာ ဖြစ်သည်။ ထပ်စမ်းကြည့်ပါ။',
  'audit.clearActor': 'အားလုံးကို ပြန်ပြရန်',
  'audit.accessGranted': 'သည် {target} အား ဝင်ရောက်ခွင့် ပေးခဲ့သည်။',
  ...
  'audit.catalogueCreated': 'သည် {kind} {target} ကို ထည့်ခဲ့သည်။',
  'audit.catalogueUpdated': 'သည် {kind} {target} ကို ပြောင်းလဲခဲ့သည် − {changes}',
  'audit.catalogueRemoved': 'သည် {kind} {target} ကို ဖယ်ရှားခဲ့သည်။',
  'audit.settingsUpdated': 'သည် ဆက်တင်များကို ပြောင်းလဲခဲ့သည် − {changes}',
  'audit.nounMenuItem': 'မီနူးပစ္စည်း',
  'audit.nounTable': 'စားပွဲ',
  'audit.nounProduct': 'ကုန်ပစ္စည်း',
  'audit.nounStation': 'ဂိမ်းစခန်း',
