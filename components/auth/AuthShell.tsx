...
// Shared customer auth chrome: full-bleed pitch-green gradient, football-pitch
// watermark, frosted-glass logo, and a white token card. Used by login + register.
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="mb-7 flex flex-col items-center text-center">
          <div
            ...
            style={{ width: 84, height: 84, background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.22)', borderRadius: 20 }}
          >
          ...
          <h1 className="font-display text-2xl font-extrabold tracking-tight text-white">{heading}</h1>
