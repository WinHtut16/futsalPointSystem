        ...
        <div className="px-4 pb-4">
          ...
          <div className="fb-card flex items-center gap-3.5 p-4">
            ...
            <div className="flex-1">
              ...
              <div className={`mt-0.5 text-[11px] text-ink-muted ${my}`}>{t('booking.confirm.viberSub')}</div>
            </div>
      ...
      {step === 3 && (
        <div className="px-4 pb-4">
          ...
          <div className="mt-5 flex gap-2.5">
            <button type="button" className="fb-btn fb-btn-ghost flex-1">
